...
${OBJECTDIR}/rng.o: rng.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/rng.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  rng.c  -o ${OBJECTDIR}/rng.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/rng.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/rng.o: rng.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/rng.o.d 
	@${RM} ${OBJECTDIR}/rng.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  rng.c  -o ${OBJECTDIR}/rng.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/rng.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/rng.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
